...
import {useUploadImage} from "@/utils/hooks/media";
          ...
          <Form onFinish={handleSubmit} labelAlign="left">
            <Row gutter={24}>
              <Col span={12}>
                ...
                <FormItem label="Email" name="email" labelCol={{span: 6}}>
                  <InputGlobal
                    name="email"
                ...
                <FormItem label="Địa chỉ" name="address" labelCol={{span: 6}}>
                  <TextAreaGlobal
                    name="address"
              ...
              <Col span={12}>
                <FormItem label="Username" name="username" labelCol={{span: 6}}>
                  <InputGlobal
                    name="username"
                ...
                <FormItem label="Vị trí" name="position" labelCol={{span: 6}}>
                  <Select
                ...
                <FormItem label="Vai trò" name="role" labelCol={{span: 6}}>
                  <Select
                ...
                <FormItem label="Trạng thái" name="verify" labelCol={{span: 6}}>
                  <Select
